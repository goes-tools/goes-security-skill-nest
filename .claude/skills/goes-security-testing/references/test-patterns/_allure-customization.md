...
> `_html-reporter-customization.md`** in this folder for the current guide,
> which covers project name, run id for parallel CI, branding, badge
> classification, and a couple of GitHub Actions / GitLab CI snippets.
>
> This file is kept as a stub only because the source skill folder is
> read-only — it can be deleted once the skill is repackaged.
